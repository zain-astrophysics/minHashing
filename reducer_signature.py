...
# Store all reviews and their MinHash signatures
reviews = {}
...
for line in sys.stdin:
    ...
    review_text, minhash_signature = line.split('\t', 1)
...
for (review_text1, minhash1), (review_text2, minhash2) in itertools.combinations(reviews.items(), 2):
    ...
    if similarity >= 0.5:  # Only emit pairs with similarity >= 0.5
        ...
        print(f"{similarity:.4f}\t{review_text1}\t{review_text2}")
